    ...
    <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between">
          <div className="flex-1">
            ...
            <p className="text-gray-300 mb-2">
              Fresh LeetCode problems generated by AI every day at 4:00 AM IST
            </p>
      ...
      <div className="mt-8 bg-gray-800/50 backdrop-blur-md p-6 rounded-lg border border-gray-700/40">
        ...
        <ul className="space-y-2 text-gray-300">
          ...
          <li className="flex items-start gap-2">
            <span className="text-blue-400 mt-1">•</span>
            <span>New questions are automatically generated daily at 4:00 AM IST</span>
          </li>
        </ul>
      </div>
