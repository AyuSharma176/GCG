...
const socialLinks = [
  { 
    name: "GitHub", 
    url: "https://github.com/AyuSharma176", // Replace with your GitHub URL
    icon: (
  ...
  { 
    name: "LinkedIn", 
    url: "https://www.linkedin.com/in/ayusharma17/", // Replace with your LinkedIn URL
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    <section className="max-w-7xl mx-auto px-6 py-16">
      <div className="text-center mb-12">
        ...
        <p className="mt-4 text-lg text-gray-300 max-w-3xl mx-auto">
          GLA Coding Group (GCG) is a dynamic student-led community dedicated to fostering a passion for technology. We aim to share resources, solve complex problems, and collectively grow our coding skills in a collaborative and supportive environment.
        </p>
      </div>
